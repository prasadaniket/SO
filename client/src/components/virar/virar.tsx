...
export default function VirarPage() {
  ...
  if (fpLoading || customerLoading) return (
    ...
    <div className="relative min-h-screen flex flex-col items-center pt-10 px-6 bg-gradient-to-b from-[#1A1A1A] to-[#000000] overflow-x-hidden">
      ...
      <main className="relative z-10 flex-1 w-full max-w-sm mx-auto flex flex-col pt-4 pb-10">
        ...
        >
          ...
          <p className="text-[#E88C3A] text-sm mt-1 opacity-80">{config.location}</p>
        </motion.div>
          ...
          {config.mapLink && (
            ...
            >
              <motion.a
                whileHover={{ y: -3, scale: 1.02 }}
                whileTap={{ scale: 0.96 }}
                href={config.mapLink} target="_blank" rel="noopener noreferrer"
        ...
        >
          ...
          {config.instagram && (
            <motion.a whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}
              href={config.instagram} target="_blank" rel="noopener noreferrer"
          ...
          {config.facebook && (
            <motion.a whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}
              href={config.facebook} target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center text-white/40 hover:text-[#E88C3A] transition-colors p-2"
            >
